...
insert into test.reservation (id, concert_detail_id, seat_id, user_id, status, created_at, updated_at) values (1, 1, 4, 1, 'COMPLETED', now(), now());
insert into test.reservation (id, concert_detail_id, seat_id, user_id, status, created_at, updated_at) values (2, 1, 12, 1, 'COMPLETED', now(), now());
insert into test.reservation (id, concert_detail_id, seat_id, user_id, status, created_at, updated_at) values (3, 1, 15, 2, 'IN_PROGRESS', now(), now());
insert into test.reservation (id, concert_detail_id, seat_id, user_id, status, created_at, updated_at) values (4, 1, 20, 2, 'CANCELLED', now(), now());
