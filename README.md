...
3. 잔액 조회 API : 4h ( ~ 4월8일)
   3-1. API 구현
   3-2. 유닛 테스트
4. 예약 가능 날짜 조회 API : 4h ( ~ 4월8일)
   4-1. API 구현
   4-2. 유닛 테스트
5. 예약 가능한 좌석 조회 API : 4h ( ~ 4월9일)
   5-1. API 구현
   5-2. 유닛 테스트
6. 좌석 예약 요청 API : 5h ( ~ 4월10일)
   6-1. API 구현
   6-2. 유닛 테스트
7. 유저 토큰 발급 API : 12h ( ~ 4월12일)
   7-1. API 구현
   7-2. 유닛 테스트

=============== 다음 주차 ===============
8. 좌석 임시 배정 5분 검증 Polling 구현
9. 잔여 시간 검증 Polling 구현
10. dummy 대기열 추가 Polling 구현
11. 통합테스트
